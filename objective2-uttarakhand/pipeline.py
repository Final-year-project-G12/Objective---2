...
USAGE
  python pipeline.py --state uttarakhand --stage geometry     # Phase 2 self-test
  python pipeline.py --state uttarakhand --stage simulate      # Phase 3 demo run (1 case)
  python pipeline.py --state uttarakhand --stage verify        # Phase 4 gates 1-5

  python pipeline.py --state uttarakhand --stage simulate --cluster 2 \\
...
def main():
    ...
    ap.add_argument("--state", required=True, help="e.g. uttarakhand")
