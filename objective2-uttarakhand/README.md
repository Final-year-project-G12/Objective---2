...
All three scripts have a `STATE = "uttarakhand" (already set)` variable near the top.
...
`era5-uttarakhand`) — everything else, including every filename below,
...
directly from `era5-uttarakhand/data/...` if you ever need row-level access):
