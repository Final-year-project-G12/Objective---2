...
PORTED FROM objective2-tamilnadu/src/surrogate/train.py — model family,
hyper-parameters and the train/holdout logic are unchanged. Only the
I/O paths differ (this repo's flat results/phaseN_* scheme instead of
TN's results/<state>/ subdirectory) and the __main__ state fallback.
"""
