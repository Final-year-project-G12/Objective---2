...
PORTED FROM objective2-tamilnadu/src/optimize/select_deployable.py --
confirmation, large-error rule and the pre-declared selection rule are
unchanged. Only the flat results/phaseN_* output paths and the __main__
