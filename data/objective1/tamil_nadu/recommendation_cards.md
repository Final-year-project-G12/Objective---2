...
|---|---|---|---|---|
| n-Octacosane (C28) | 1 | 91.2% | No | 1 |
| n-Hexacosane (C26) | 2 | 94.3% | No | 0 |
| PureTemp 58 | 3 | 94.2% | No | 0 |
| RT57HC | 4 | 94.3% | No | 0 |
| PureTemp 53 | 5 | 95.4% | No | 0 |

*Spearman rho (MCDM rank vs. simulated solar fraction) for this cluster: -0.152 — weak agreement — diagnose before trusting the MCDM ranking here*
...
| PCM | Consensus rank | Simulated solar fraction | In 54-84% benchmark band? | Complete cycles/yr |
|---|---|---|---|---|
| n-Octacosane (C28) | 1 | 92.2% | No | 1 |
| RT64HC | 2 | 93.1% | No | 1 |
| n-Hexacosane (C26) | 3 | 96.4% | No | 0 |
| n-Nonacosane (C29) | 4 | 93.1% | No | 1 |
| RT57HC | 5 | 96.4% | No | 0 |

*Spearman rho (MCDM rank vs. simulated solar fraction) for this cluster: -0.184 — weak agreement — diagnose before trusting the MCDM ranking here*
...
| PCM | Consensus rank | Simulated solar fraction | In 54-84% benchmark band? | Complete cycles/yr |
|---|---|---|---|---|
| n-Octacosane (C28) | 1 | 90.3% | No | 1 |
| PureTemp 58 | 2 | 91.3% | No | 1 |
| n-Hexacosane (C26) | 3 | 93.3% | No | 0 |
| PureTemp 60 | 4 | 91.5% | No | 1 |
| PureTemp 53 | 5 | 95.7% | No | 0 |

*Spearman rho (MCDM rank vs. simulated solar fraction) for this cluster: 0.094 — weak agreement — diagnose before trusting the MCDM ranking here*
...
| PCM | Consensus rank | Simulated solar fraction | In 54-84% benchmark band? | Complete cycles/yr |
|---|---|---|---|---|
| n-Octacosane (C28) | 1 | 94.9% | No | 0 |
| PureTemp 58 | 2 | 95.0% | No | 0 |
| n-Hexacosane (C26) | 3 | 96.4% | No | 0 |
| PureTemp 60 | 4 | 94.8% | No | 0 |
| PureTemp 53 | 5 | 96.6% | No | 0 |

*Spearman rho (MCDM rank vs. simulated solar fraction) for this cluster: -0.044 — weak agreement — diagnose before trusting the MCDM ranking here*
...
| PCM | Consensus rank | Simulated solar fraction | In 54-84% benchmark band? | Complete cycles/yr |
|---|---|---|---|---|
| n-Octacosane (C28) | 1 | 93.1% | No | 1 |
| RT64HC | 2 | 85.3% | No | 1 |
| n-Hexacosane (C26) | 3 | 94.9% | No | 0 |
| n-Nonacosane (C29) | 4 | 85.3% | No | 1 |
| RT57HC | 5 | 94.9% | No | 0 |

*Spearman rho (MCDM rank vs. simulated solar fraction) for this cluster: -0.471 — weak agreement — diagnose before trusting the MCDM ranking here*
